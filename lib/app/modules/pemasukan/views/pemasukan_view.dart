                ...
                children: [
                  ...
                  Center(
                    child: Obx(() {
                      ...
                      return Text(
                        'Rp. ${saldoController.totalSaldo.value.toStringAsFixed(2)}',  // Menggunakan controller global
                        style: TextStyle(
                          color: Colors.white,
                          fontSize: 32,
                          fontWeight: FontWeight.bold,
              ...
              child: Container(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Obx(() {
                      return Text(
                        'Rp. ${masukcontroller.pendapatanBulanIni.value.toStringAsFixed(2)}',
                        style: TextStyle(
                          fontSize: 20,
                          fontWeight: FontWeight.bold,
                        ),
                    ...
                    SizedBox(
                      ...
                      child: Obx(() {
                        if (masukcontroller.chartData.isEmpty) {
                          return Center(
                            child: Text(
                        ...
                        return LineChart(
                          LineChartData(
                            ...
                            lineBarsData: [
                              LineChartBarData(
                                spots: masukcontroller.chartData, // Use dynamic chart data from controller
                                isCurved: true,
                                color: Colors.greenAccent, // Line color
                                dotData: FlDotData(
                                  show: true, // Show dots
          ...
          child: Column(
            ...
            children: [
              Obx(() {
                ...
                if (masukcontroller.recentTransactions.isEmpty) {
                  return Center(
                    child: Text(
                  ...
                  return Column(
                    children: masukcontroller.recentTransactions.asMap().entries.map((entry) {
                      int index = entry.key;
                      var transaction = entry.value;

                      return TransactionItem(
                        icon: Icons.attach_money, color: Colors.green, // Add the appropriate icon
                  ...
                  child: ElevatedButton(
                    onPressed: () {
                      if (nameController.text.isEmpty) {
                        ...
                        Get.snackbar("Failed", "Nama Transaksi minimal 5 karakter",
                          backgroundColor: Colors.red, colorText: Colors.white);
                      } else if (nameController.text.length > 20) {
                        Get.snackbar("Failed", "Nama Transaksi maksimal 20 karakter",
                          backgroundColor: Colors.red, colorText: Colors.white);
                      } else if (!nameRegex.hasMatch(nameController.text)) {
                        Get.snackbar("Failed", "Nama Transaksi tidak boleh mengandung simbol",
                          backgroundColor: Colors.red, colorText: Colors.white);
                    ...
                    onPressed: () {
                      if (nameController.text.isEmpty) {
                        ...
                        Get.find<PemasukanController>()
                            ...
                            updatedTransaction;
                        Get.find<PemasukanController>().editData(widget.transactionIndex, double.parse(amountController.text));
                ...
                Expanded(
                  child: ElevatedButton(
                    onPressed: () {
                      ...
                      Get.find<PemasukanController>().deleteData(transactionIndex);
